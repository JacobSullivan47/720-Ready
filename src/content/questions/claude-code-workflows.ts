...
export const questions: QuestionSeed[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "In an Agent SDK hook that intercepts and can block the tool call",
    ],
    correctIndexes: [3],
    explanation:
  ...
  },
  {
    ...
    options: [
      "The Agent SDK provides its own context management, such as compaction as the session grows",
